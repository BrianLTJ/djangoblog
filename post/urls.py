...
from post import cate as cate_views
...
urlpatterns =[
    ...
    url(r'/category', cate_views.cate_index, name='dashboard_cate'),
    url(r'/category/handler', cate_views.cate_handler, name='cate_handler'),

    url(r'/tag', post_views.post_tag_page, name='dashboard_tag'),
